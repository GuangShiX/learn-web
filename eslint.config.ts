...
// Configuration
const ENABLE_TYPE_CHECKED = false // Set to enable project-based type checking
const ENABLE_FRONTEND = true // Set to enable Next.js, JSX, React, Hooks, and other frontend features
